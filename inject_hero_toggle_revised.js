...
if (paragraphEndIndex !== -1) {
    ...
    // We will place the toggle immediately after the <p> so it sits beside/above the symbols depending on flex direction.
    // The user wants it smaller and left-aligned.
    const newToggleAndSymbols = `
                <style>
                    /* ====== HERO SEGMENTED CONTROL TOGGLE (SMALLER / LEFT ALIGNED) ====== */
                    .hero-toggle-container {
                        display: flex;
                        justify-content: flex-start; /* Left aligned */
                        margin: 1.5rem 0 0 0; /* Reduced margin, no auto margin */
                        padding: 0;
                        position: relative;
                        z-index: 10;
                    }
                    ...
                    .hero-toggle-track {
                        ...
                        box-shadow: 0 4px 20px rgba(0, 0, 0, 0.4), inset 0 2px 10px rgba(0, 0, 0, 0.3);
                    ...
                    .hero-toggle-slider {
                        ...
                        border-radius: 40px;
                        z-index: 1;
                        transition: transform 0.4s cubic-bezier(0.86, 0, 0.07, 1), background 0.4s ease, box-shadow 0.4s ease;
                    ...
                    @media (max-width: 640px) {
                        .hero-toggle-container {
                            justify-content: center; /* Center on mobile to look better */
                        }
                    }
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    // We DO NOT update the hero Title text, only the glow and the symbols.
...
`;
    ...
    // Only inject at the specific markers so we strictly preserve the Title text up top.
    ...
    console.log("Successfully injected revised left-aligned static-text hero toggle logic.");
} else {
