  ...
  sections: [
    {
      ...
      body: [
        ...
        { kind: 'grid3', mt: true, cells: [
          ...
          { h3: 'A second clue', p: 'The salinity column runs from 7.24 to 8.89, the same range as pH, while conductivity in the same water reads between 0.167 and 0.409. Salinity\'s correlation with conductivity is 0.313, exactly the same as pH\'s, and its correlation with pH is 1.000: the column carries nothing the pH column does not.' },
