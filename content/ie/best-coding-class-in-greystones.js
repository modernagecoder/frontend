...
module.exports = {
  clusterName: 'Ireland',
  hub: { group: 'town', tag: 'GREYSTONES', blurb: 'A Wicklow coastal town at the end of the DART line, with a project on two census questions that are constantly mistaken for each other.' },
  ...
  sections: [
    {
      ...
      body: [
        ...
        { kind: 'grid3', mt: true, cells: [
          ...
          { h3: 'Even the missing answers differ', p: 'The citizenship block records 440 residents who did not state one. The birthplace block publishes no not stated row at all, so the two are not even incomplete in the same way.' }
        ] },
...
`,
  ...
  dossier: {
    ...
    sources: [
      { claim: 'CSO Census 2022 table SAP2022T2T1TOWN22, Greystones-Delgany, Co Wicklow, total 21,701 on both blocks. Birthplace: Ireland 17,313, United Kingdom 1,553, Rest of World 1,474, Other EU 892, Poland 291, India 178, no not-stated row. Citizenship: Ireland 18,813, Other EU 820, Rest of World 707, United Kingdom 543, Poland 279, India 99, not stated 440.', url: 'https://ws.cso.ie/public/api.restful/PxStat.Data.Cube_API.ReadDataset/SAP2022T2T1TOWN22/JSON-stat/2.0/en' },
