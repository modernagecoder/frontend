...
`,
  ...
  dossier: {
    ...
    sources: [
      ...
      { claim: 'CSO Census 2022 table SAP2022T15T2CTY, Households with Internet access by administrative county: Donegal County Council 61,575 households, of which 46,882 broadband, 2,830 other connection, 7,777 no internet and 4,086 not stated.', url: 'https://ws.cso.ie/public/api.restful/PxStat.Data.Cube_API.ReadDataset/SAP2022T15T2CTY/JSON-stat/2.0/en' }
    ],
    rejectedClaims: [
      ...
      'Presenting the Border region survey figure as a Donegal figure: the county figure comes from the census table and the regional figure is labelled as regional.',
