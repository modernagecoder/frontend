...
module.exports = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Is broadband good enough in Mayo?', a: 'The census gives a county answer: in April 2022, 38,640 of Mayo\'s 51,996 households had broadband and 6,965 had no internet. Your own line is what matters, and the free lesson tests it directly.' },
...
`,
  ...
  dossier: {
    ...
    sources: [
      ...
      { claim: 'CSO Internet Coverage and Usage in Ireland 2023: the West region, comprising Galway, Mayo and Roscommon, at 92 percent of households with an internet connection and 83 percent on fixed broadband. The survey publishes no county figure; the census table does.', url: 'https://www.cso.ie/en/releasesandpublications/ep/p-isshict/internetcoverageandusageinireland2023/householdinternetconnectivity/' },
      ...
      { claim: 'CSO Census 2022 table SAP2022T15T2CTY, Households with Internet access by administrative county: Mayo County Council 51,996 households, of which 38,640 broadband, 3,242 other connection, 6,965 no internet and 3,149 not stated.', url: 'https://ws.cso.ie/public/api.restful/PxStat.Data.Cube_API.ReadDataset/SAP2022T15T2CTY/JSON-stat/2.0/en' }
    ],
    rejectedClaims: [
      ...
      'Presenting the West region internet survey figure as a Mayo figure: the county figure used comes from the census table of internet access by county.',
