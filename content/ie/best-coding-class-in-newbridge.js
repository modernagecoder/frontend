...
module.exports = {
  clusterName: 'Ireland',
  hub: { group: 'town', tag: 'NEWBRIDGE', blurb: 'In 260 of the 868 towns in one census column, a cell holds exactly one person. What that means for anyone building with data.' },
  ...
  sections: [
    {
      ...
      intro: 'The Newbridge column beside the smallest entries in the same table. Counts are published; the tallies across all 868 towns were computed by us on 18 September 2026.',
      body: [
