...
//    the age of 60 at the start of their course", and "Learners who are aged 60 or over at the start of
//    their course may still qualify for maintenance support, though not a tuition fee loan."
...
module.exports = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Is there an age limit on that funding?', a: 'Yes. Tuition loans under the LLE are available to people up to the age of 60 at the start of their course. GOV.UK adds that learners aged 60 or over may still qualify for maintenance support, though not a tuition fee loan.' },
