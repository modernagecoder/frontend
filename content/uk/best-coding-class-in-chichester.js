  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        { kind: 'grid3', mt: true, cells: [
          { h3: '1. Count the days', p: 'Download 16,561 daily mean flows from the Environment Agency and count, for each year from October to September, the days with flow. The record has three years with none at all: 1989, 1996 and 1997.' },
          ...
          { h3: '3. Ask about chance', p: 'Work out how big S would usually be if the years came in random order. For any flow, a value of 221 or more happens by chance only about 2.6% of the time.' }
        ] },
