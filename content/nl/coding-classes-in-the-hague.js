...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Escamp', p: 'The largest district by far, 128,967 people in 2022, and the post-war south-west: Bouwlust 29,012, Wateringse Veld 24,628, Moerwijk 21,974, Morgenstond 20,553, Rustenburg en Oostbroek 18,994, Leyenburg 17,143. Six wijken, each the size of a Dutch town.' },
          { h3: 'Centrum', p: '106,261 people in 2022 and the densest immigrant history in the city: the Schildersbuurt at 30,102 and the Transvaalkwartier at 16,335 are where the Hindustani community of The Hague is most visible, along with the Stationsbuurt at 12,945 and the Centrum wijk itself at 21,955.' },
          { h3: 'Laak and Leidschenveen-Ypenburg', p: 'Laak, 47,305, is one enormous wijk and the Binckhorst being rebuilt beside it. Leidschenveen-Ypenburg, 48,273, is the newest district: Ypenburg 26,358 and Leidschenveen 20,049, built on the old airfield, and home to two of the British School\'s three Hague campuses on the Vrouw Avenweg.' },
          ...
          { h3: 'Haagse Hout', p: '48,606 people: Bezuidenhout 19,254 behind the central station, Benoordenhout 15,393 with the European School and the international organisations of the Oostduinlaan and the Van Alkemadelaan, and Mariahoeve en Marlot 15,759 on the edge of the Haagse Bos.' },
