...
module.exports = {
  ...
  next: {
    ...
    html: 'Above it is the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>, which owns the national curriculum argument and lists every course. Beside it are <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a>, <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a> and <a class="cg-inline-link" href="/coding-classes-in-eindhoven">Eindhoven</a>, each written the way this one is. For a learner whose goal is a trained model rather than a program, the right door is <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a>. Below this page sits <a class="cg-inline-link" href="/coding-classes-in-the-hague-centrum">Den Haag Centrum</a>, the first of the eight stadsdeel pages, with the other seven on their way.',
