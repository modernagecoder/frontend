...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Laak and Leidschenveen-Ypenburg', p: 'Laak, 47,305, is one enormous wijk and the Binckhorst being rebuilt beside it, and <a class="cg-inline-link" href="/coding-classes-in-laak">its page</a> shows why the Binckhorst age table is a fact about what was built rather than about what anyone preferred. Leidschenveen-Ypenburg, 48,273, is the newest district: Ypenburg 26,358 and Leidschenveen 20,049, built on the old airfield, and home to two of the British School\'s three Hague campuses on the Vrouw Avenweg.' },
  ...
  next: {
    ...
    html: 'Above it is the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>, which owns the national curriculum argument and lists every course. Beside it are <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a>, <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a> and <a class="cg-inline-link" href="/coding-classes-in-eindhoven">Eindhoven</a>, each written the way this one is. For a learner whose goal is a trained model rather than a program, the right door is <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a>. Below this page sit <a class="cg-inline-link" href="/coding-classes-in-the-hague-centrum">Den Haag Centrum</a>, <a class="cg-inline-link" href="/coding-classes-in-escamp">Escamp</a>, <a class="cg-inline-link" href="/coding-classes-in-scheveningen">Scheveningen</a> , <a class="cg-inline-link" href="/coding-classes-in-haagse-hout">Haagse Hout</a> and <a class="cg-inline-link" href="/coding-classes-in-laak">Laak</a>, the first five of the eight stadsdeel pages, with the other three on their way.',
