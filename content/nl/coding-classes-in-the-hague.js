...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Loosduinen', p: '<a class="cg-inline-link" href="/coding-classes-in-loosduinen">Its page</a> works out that the WOZ figure quoted all over this series is an estimate rather than a count. 51,395 people in the west: the old village of Loosduinen 17,884, Waldeck 17,950, Kraayenstein en Vroondaal 10,743, and Kijkduin en Ockenburgh 3,978, where the International School of The Hague sits at Wijndaelerweg 11 with 1,174 Hague-resident pupils.' }
        ] },
  ...
  next: {
    ...
    html: 'Above it is the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>, which owns the national curriculum argument and lists every course. Beside it are <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a>, <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a> and <a class="cg-inline-link" href="/coding-classes-in-eindhoven">Eindhoven</a>, each written the way this one is. For a learner whose goal is a trained model rather than a program, the right door is <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a>, and the <a class="cg-inline-link" href="/ai-and-python-academy-the-hague">AI and Python Academy, The Hague</a> studies what goes wrong when a risk model is trusted too far. Below this page sit <a class="cg-inline-link" href="/coding-classes-in-the-hague-centrum">Den Haag Centrum</a>, <a class="cg-inline-link" href="/coding-classes-in-escamp">Escamp</a>, <a class="cg-inline-link" href="/coding-classes-in-scheveningen">Scheveningen</a> , <a class="cg-inline-link" href="/coding-classes-in-haagse-hout">Haagse Hout</a>, <a class="cg-inline-link" href="/coding-classes-in-laak">Laak</a>, <a class="cg-inline-link" href="/coding-classes-in-leidschenveen-ypenburg">Leidschenveen-Ypenburg</a>, <a class="cg-inline-link" href="/coding-classes-in-loosduinen">Loosduinen</a> and <a class="cg-inline-link" href="/coding-classes-in-segbroek">Segbroek</a>. All eight stadsdeel pages are now written.',
