...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Amstelland-Meerlanden: the airport and the suburbs', p: '<a class="cg-inline-link" href="/coding-classes-in-haarlemmermeer">Haarlemmermeer</a> 166,978, which is Hoofddorp, Schiphol and a drained lake, with its own page; Amstelveen 95,840, with a page of its own; Aalsmeer 33,459; Diemen 33,327; Uithoorn 32,204, which has the second highest Indian-origin share in the country and gets its own page in this series; Ouder-Amstel 14,525.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which towns in Noord-Holland get their own page, and which are covered here?', a: 'Amsterdam, Amstelveen and <a class="cg-inline-link" href="/coding-classes-in-haarlem">Haarlem</a> already have pages, and so does <a class="cg-inline-link" href="/coding-classes-in-haarlemmermeer">Haarlemmermeer</a>. Zaanstad, Alkmaar, Hilversum, Purmerend, Hoorn and Uithoorn follow in this series. The other 34 municipalities, from Dijk en Waard to Oostzaan, are named on this page with their populations, and a family in any of them books exactly the same class.' },
