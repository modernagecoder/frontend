...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Zuid-Kennemerland: the capital and the dunes', p: 'Haarlem 168,898, the provincial capital and the second city; Heemstede 27,556; Bloemendaal 23,554; Zandvoort 17,335. Fifteen minutes from Amsterdam by train and a different place entirely in character, with the dunes and the sea at the end of the road.' },
          { h3: 'Amstelland-Meerlanden: the airport and the suburbs', p: 'Haarlemmermeer 166,978, which is Hoofddorp, Schiphol and a drained lake; Amstelveen 95,840, with a page of its own; Aalsmeer 33,459; Diemen 33,327; Uithoorn 32,204, which has the second highest Indian-origin share in the country and gets its own page in this series; Ouder-Amstel 14,525.' },
          { h3: 'Zaanstreek-Waterland: north of the IJ', p: 'Zaanstad 165,201, fourth in the province and a page to come; Purmerend 96,182; Edam-Volendam 37,126; Waterland 17,721; Wormerland 16,328; Landsmeer 11,685; Oostzaan 9,778. Commuter country with its own identity and its own dialect.' },
          { h3: 'Gooi en Vechtstreek: the media towns', p: 'Hilversum 94,595, the broadcasting town and a page to come; Gooise Meren 61,213, which is Bussum, Naarden and Muiden; Huizen 41,287; Wijdemeren 24,672; Blaricum 12,938; Laren 11,547. The wealthiest corner of the province and the one with the most international families outside Amstelveen.' },
          { h3: 'Alkmaar and IJmond: the cheese town and the steel coast', p: 'Alkmaar 113,196, fifth in the province and a page to come; Dijk en Waard 91,411, formed from Heerhugowaard and Langedijk; Castricum 37,077; Heiloo 24,613; Bergen 29,653; and on the coast Velsen 70,361, Beverwijk 43,052, Heemskerk 39,529 and Uitgeest 13,489, around the steelworks at the mouth of the canal.' },
          { h3: 'The Kop and West-Friesland: the far north', p: 'Den Helder 56,678, the navy town at the tip; Hollands Kroon 50,592; Schagen 48,778; Texel 13,958, the island, forty-six percent of whose 463 square kilometres is water. Hoorn 76,202, with a page to come; Medemblik 46,305; Koggenland 24,214; Stede Broec 22,445; Drechterland 20,550; Enkhuizen 18,738; Opmeer 12,669.' }
        ] },
  ...
  next: {
    ...
    h2: 'Down to the two cities that have pages, and up to the country',
    html: 'Inside this province, <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a> has a page that hands off to eight districts and <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a> one written for the town with the highest Indian-origin share in the country. Above both sits the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>. Across the province line, <a class="cg-inline-link" href="/coding-classes-in-almere">Almere</a> and <a class="cg-inline-link" href="/coding-classes-in-utrecht">Utrecht</a> are the nearest neighbours with pages. For a learner who wants to build models rather than programs, the doors are <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a> and the <a class="cg-inline-link" href="/ai-and-python-academy-netherlands">AI and Python Academy</a>.',
