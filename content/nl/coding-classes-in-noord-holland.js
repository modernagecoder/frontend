...
module.exports = {
  ...
  next: {
    ...
    html: 'Inside this province, <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a> has a page that hands off to eight districts and <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a> one written for the town with the highest Indian-origin share in the country. <a class="cg-inline-link" href="/coding-classes-in-haarlem">Haarlem</a>, <a class="cg-inline-link" href="/coding-classes-in-haarlemmermeer">Haarlemmermeer</a>, <a class="cg-inline-link" href="/coding-classes-in-zaanstad">Zaanstad</a>, <a class="cg-inline-link" href="/coding-classes-in-alkmaar">Alkmaar</a>, <a class="cg-inline-link" href="/coding-classes-in-purmerend">Purmerend</a>, <a class="cg-inline-link" href="/coding-classes-in-hilversum">Hilversum</a>, <a class="cg-inline-link" href="/coding-classes-in-hoorn">Hoorn</a>, <a class="cg-inline-link" href="/coding-classes-in-uithoorn">Uithoorn</a> and <a class="cg-inline-link" href="/coding-classes-in-weesp">Weesp</a> have pages of their own as well. Above them all sits the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>. Across the province line, <a class="cg-inline-link" href="/coding-classes-in-almere">Almere</a> and <a class="cg-inline-link" href="/coding-classes-in-utrecht">Utrecht</a> are the nearest neighbours with pages. For a learner who wants to build models rather than programs, the doors are <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a> and the <a class="cg-inline-link" href="/ai-and-python-academy-netherlands">AI and Python Academy</a>.',
