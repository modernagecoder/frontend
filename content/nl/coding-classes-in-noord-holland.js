    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Amstelland-Meerlanden: the airport and the suburbs', p: '<a class="cg-inline-link" href="/coding-classes-in-haarlemmermeer">Haarlemmermeer</a> 166,978, which is Hoofddorp, Schiphol and a drained lake, with its own page; Amstelveen 95,840, with a page of its own; Aalsmeer 33,459; Diemen 33,327; <a class="cg-inline-link" href="/coding-classes-in-uithoorn">Uithoorn</a> 32,204, which has the second highest Indian-origin share in the country and now has its own page; Ouder-Amstel 14,525.' },
