...
module.exports = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Gelderland towns get their own page, and which are covered here?', a: '<a class="cg-inline-link" href="/coding-classes-in-nijmegen">Nijmegen</a> has its own page; Arnhem, Apeldoorn and Ede follow in this series. The other 47 municipalities, from Barneveld and Doetinchem to Rozendaal, are listed above with their populations, and the class is identical whichever one the laptop is in.' },
