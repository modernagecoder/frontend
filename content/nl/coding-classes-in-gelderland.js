...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'The Rijk van Nijmegen', p: 'Nijmegen 189,871, the largest city and a page to come; Wijchen 42,106; Berg en Dal 35,700; Beuningen 26,868; Heumen 16,978; Druten 20,019; West Maas en Waal 20,843. The university, the hospital, and the oldest city in the country by its own account.' },
          { h3: 'Arnhem and its ring', p: 'Arnhem 171,822, the capital and a page to come; Lingewaard 47,802; Overbetuwe 49,266; Zevenaar 45,570; Rheden 43,849; Renkum 31,356; Duiven 24,852; Westervoort 15,253; Doesburg 11,173; Rozendaal 1,837, the smallest municipality in the province.' },
          { h3: 'The Veluwe', p: 'Apeldoorn 169,212, third and a page to come; Ede 125,331, fourth and a page to come; Barneveld 63,926; Harderwijk 50,655; Nijkerk 46,283; Epe 33,785; Nunspeet 29,688; Ermelo 28,199; Putten 25,170; Oldebroek 24,535; Elburg 24,039; Heerde 19,325; Hattem 12,822; Scherpenzeel 10,674; Wageningen 42,779 on its southern edge, with the agricultural university.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Gelderland towns get their own page, and which are covered here?', a: 'Nijmegen, Arnhem, Apeldoorn and Ede follow in this series. The other 47 municipalities, from Barneveld and Doetinchem to Rozendaal, are listed above with their populations, and the class is identical whichever one the laptop is in.' },
