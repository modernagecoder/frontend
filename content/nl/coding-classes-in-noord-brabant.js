...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: '\'s-Hertogenbosch and the Meierij', p: '<a class="cg-inline-link" href="/coding-classes-in-den-bosch">\'s-Hertogenbosch</a> 162,295, the capital, called Den Bosch by everyone in it, with its own page; <a class="cg-inline-link" href="/coding-classes-in-meierijstad">Meierijstad</a> 85,236, with its own page; Boxtel 34,302; Vught 33,202; Sint-Michielsgestel 30,191. The province\'s seat and the bailiwick that historically surrounded it.' },
          ...
          { h3: 'The Markiezaat and the west', p: '<a class="cg-inline-link" href="/coding-classes-in-roosendaal">Roosendaal</a> 78,165, with its own page; <a class="cg-inline-link" href="/coding-classes-in-bergen-op-zoom">Bergen op Zoom</a> 70,691, with its own page; Moerdijk 38,467; Halderberge 31,484; Steenbergen 24,596; Woensdrecht 22,301. The marquisate on the Scheldt, the port at Moerdijk and the polders towards Zeeland.' }
        ] },
        { kind: 'p', text: 'Fifty-six, every one of them above. Eindhoven, Tilburg, Breda, \'s-Hertogenbosch, Helmond, Oss, Meierijstad, Roosendaal and Bergen op Zoom have pages that go close. This page keeps the whole province in one frame, Boekel and Baarle included.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Noord-Brabant towns get their own page, and which are covered here?', a: 'Eindhoven, Tilburg, Breda, \'s-Hertogenbosch, Helmond, Oss, Meierijstad, Roosendaal and Bergen op Zoom have pages already. The other 47, from Boxtel and Vught to Boekel and Baarle-Nassau, are listed above with their populations and served from this page.' },
  ...
  next: {
    ...
    html: 'The province\'s largest city already has its page: <a class="cg-inline-link" href="/coding-classes-in-eindhoven">Eindhoven</a>, with the Brainport ratio chain. East along the A67 is <a class="cg-inline-link" href="/coding-classes-in-limburg">Limburg</a>, with the hill that stopped being the highest point in the country. Both sit under the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>, and a learner who wants a model that learns rather than a program that runs should look at <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a> or the <a class="cg-inline-link" href="/ai-and-python-academy-netherlands">AI and Python Academy</a>. <a class="cg-inline-link" href="/coding-classes-in-tilburg">Tilburg</a> has its page; <a class="cg-inline-link" href="/coding-classes-in-breda">Breda</a> too; so do <a class="cg-inline-link" href="/coding-classes-in-den-bosch">Den Bosch</a> and <a class="cg-inline-link" href="/coding-classes-in-helmond">Helmond</a>; and so do <a class="cg-inline-link" href="/coding-classes-in-oss">Oss</a>, <a class="cg-inline-link" href="/coding-classes-in-meierijstad">Meierijstad</a> and <a class="cg-inline-link" href="/coding-classes-in-roosendaal">Roosendaal</a>, and so does <a class="cg-inline-link" href="/coding-classes-in-bergen-op-zoom">Bergen op Zoom</a>.',
