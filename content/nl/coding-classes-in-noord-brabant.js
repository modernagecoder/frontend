...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'The Markiezaat and the west', p: '<a class="cg-inline-link" href="/coding-classes-in-roosendaal">Roosendaal</a> 78,165, with its own page; Bergen op Zoom 70,691; Moerdijk 38,467; Halderberge 31,484; Steenbergen 24,596; Woensdrecht 22,301. The marquisate on the Scheldt, the port at Moerdijk and the polders towards Zeeland.' }
        ] },
        { kind: 'p', text: 'Fifty-six, every one of them above. Eindhoven, Tilburg, Breda, \'s-Hertogenbosch, Helmond, Oss, Meierijstad and Roosendaal have pages that go close, and Bergen op Zoom will follow. This page keeps the whole province in one frame, Boekel and Baarle included.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Noord-Brabant towns get their own page, and which are covered here?', a: 'Eindhoven, Tilburg, Breda, \'s-Hertogenbosch, Helmond, Oss, Meierijstad and Roosendaal have pages already. Bergen op Zoom follows in this series. The other 47, from Boxtel and Vught to Boekel and Baarle-Nassau, are listed above with their populations and served from this page.' },
