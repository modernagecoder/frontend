...
module.exports = {
  ...
  next: {
    ...
    html: 'Thirty minutes north-west is <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a>, with its eight district pages, and beyond it <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a>; forty minutes south is <a class="cg-inline-link" href="/coding-classes-in-eindhoven">Eindhoven</a>; west along the A12 is <a class="cg-inline-link" href="/coding-classes-in-the-hague">The Hague</a>; and across the Hollandse Brug, <a class="cg-inline-link" href="/coding-classes-in-almere">Almere</a>. All of them spoke from the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>, and the learner who wants to train models rather than write programs should start at <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a>. The <a class="cg-inline-link" href="/coding-classes-in-utrecht-province">province of Utrecht</a> and <a class="cg-inline-link" href="/coding-classes-in-amersfoort">Amersfoort</a> have pages of their own, and the <a class="cg-inline-link" href="/ai-and-python-academy-utrecht">AI and Python Academy, Utrecht</a> looks at intelligence from four sides.',
