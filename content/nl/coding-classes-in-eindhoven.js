...
module.exports = {
  ...
  next: {
    ...
    html: 'The <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a> carries the national curriculum picture and the full course list. <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Coding classes in Amsterdam</a> and <a class="cg-inline-link" href="/coding-classes-in-amstelveen">coding classes in Amstelveen</a> cover the capital and the municipality with the highest Indian-origin share in the country, and <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a> is for the learner who wants to build models. Below this page sits <a class="cg-inline-link" href="/coding-classes-in-eindhoven-centrum">Eindhoven Centrum</a>, the first of seven stadsdeel pages, with Stratum, Gestel, Strijp, Woensel-Zuid, Woensel-Noord and Tongelre to follow, and pages for the rest of Noord-Brabant after them.',
