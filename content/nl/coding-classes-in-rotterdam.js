    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Delfshaven and Charlois', p: '<a class="cg-inline-link" href="/coding-classes-in-delfshaven">Delfshaven</a>, 76,590, is the old harbour town swallowed by the city and now has a page on why counting schools gets the answer backwards, with Spangen, Bospolder and Tussendijken. Charlois, 70,932, is the south-west: Carnisse, Tarwewijk, Pendrecht, Zuidwijk. Two of the densest and youngest gebieden in the city.' },
