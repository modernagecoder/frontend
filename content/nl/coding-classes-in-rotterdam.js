...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Prins Alexander', p: '<a class="cg-inline-link" href="/coding-classes-in-prins-alexander">Its page</a> holds two opposite histories open for one age table. The largest gebied at 97,794 and the north-eastern suburb: Ommoord, Zevenkamp, Nesselande, Oosterflank, built from the 1960s onward on drained polder land, with the Alexandrium and its own metro stations. A page of its own follows.' },
          { h3: 'Feijenoord and IJsselmonde', p: '<a class="cg-inline-link" href="/coding-classes-in-feijenoord">Feijenoord</a>, 81,512, is the south bank across the Swan, with a page on why four districts agreeing proves nothing: the Kop van Zuid, the Afrikaanderwijk, the Hillesluis, and De Hef on the Slaghekstraat. <a class="cg-inline-link" href="/coding-classes-in-ijsselmonde">IJsselmonde</a>, 63,475, whose page takes apart a symmetry the age bands invented, lies further south-east around the stadium. Both get their own pages.' },
          { h3: 'Delfshaven and Charlois', p: '<a class="cg-inline-link" href="/coding-classes-in-delfshaven">Delfshaven</a>, 76,590, is the old harbour town swallowed by the city and now has a page on why counting schools gets the answer backwards, with Spangen, Bospolder and Tussendijken. <a class="cg-inline-link" href="/coding-classes-in-charlois">Charlois</a>, 70,932, is the south-west, with a page on a percentage that halves when you change its base: Carnisse, Tarwewijk, Pendrecht, Zuidwijk. Two of the densest and youngest gebieden in the city.' },
          { h3: 'Kralingen-Crooswijk and Noord', p: '<a class="cg-inline-link" href="/coding-classes-in-kralingen-crooswijk">Kralingen-Crooswijk</a>, 54,856, whose page rules out the explanation everybody reaches for first, holds the Woudestein campus of Erasmus University and the Kralingse Plas; Noord, 51,962, the Bergweg, the Agniesebuurt and Blijdorp. Noord is covered inside this page rather than given a URL.' },
          { h3: 'Hillegersberg-Schiebroek and Centrum', p: '<a class="cg-inline-link" href="/coding-classes-in-hillegersberg-schiebroek">Hillegersberg-Schiebroek</a>, 44,792, whose page counts how many of its four flattering measures are actually separate, is the leafy north with the Bergse plassen, the Melanchthon Schiebroek and the international school at Nord Anglia. <a class="cg-inline-link" href="/coding-classes-in-rotterdam-centrum">Centrum</a>, 42,924, is the rebuilt heart, and its page argues that a district this small is mostly edge: the Lijnbaan, the Markthal, the Wolfert and the Erasmiaans on the Wytemaweg.' },
  ...
  next: {
    ...
    html: 'Twenty minutes up the A13 is <a class="cg-inline-link" href="/coding-classes-in-the-hague">The Hague</a>, whose page explains the Surinamese-origin figure this one only cites; up the A2 is <a class="cg-inline-link" href="/coding-classes-in-utrecht">Utrecht</a>; and beyond them <a class="cg-inline-link" href="/coding-classes-in-amsterdam">Amsterdam</a>, <a class="cg-inline-link" href="/coding-classes-in-amstelveen">Amstelveen</a>, <a class="cg-inline-link" href="/coding-classes-in-almere">Almere</a> and <a class="cg-inline-link" href="/coding-classes-in-eindhoven">Eindhoven</a>. Every one of them spokes from the <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a>, and a learner who wants to train models rather than write programs should start at <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a>, and the <a class="cg-inline-link" href="/ai-and-python-academy-rotterdam">AI and Python Academy, Rotterdam</a> follows the port’s forecasts from prediction to proof. <a class="cg-inline-link" href="/coding-classes-in-rotterdam-centrum">Rotterdam Centrum</a> and <a class="cg-inline-link" href="/coding-classes-in-delfshaven">Delfshaven</a> and <a class="cg-inline-link" href="/coding-classes-in-feijenoord">Feijenoord</a> and <a class="cg-inline-link" href="/coding-classes-in-charlois">Charlois</a> and <a class="cg-inline-link" href="/coding-classes-in-ijsselmonde">IJsselmonde</a> and <a class="cg-inline-link" href="/coding-classes-in-kralingen-crooswijk">Kralingen-Crooswijk</a> and <a class="cg-inline-link" href="/coding-classes-in-hillegersberg-schiebroek">Hillegersberg-Schiebroek</a> and <a class="cg-inline-link" href="/coding-classes-in-prins-alexander">Prins Alexander</a> complete all eight gebied pages.',
