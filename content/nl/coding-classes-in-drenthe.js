...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Assen', p: '<a class="cg-inline-link" href="/coding-classes-in-assen">Assen</a> 70,769, the capital, the TT circuit, the provincial museum with the bog bodies, and a page of its own.' },
        ...
        { kind: 'p', text: 'Twelve, and every one is above. Emmen and Assen already have pages of their own and Hoogeveen will follow; this one keeps the whole province, radio telescopes and stone tombs included, in one view.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Do Emmen, Assen and Hoogeveen get pages of their own?', a: 'Emmen and Assen have theirs now, both linked further up this page. Hoogeveen follows later in the series. The other nine municipalities, Meppel and Coevorden down to Westerveld, are listed above with their populations and this is their page.' },
