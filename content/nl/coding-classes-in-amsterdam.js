...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Zuid', p: '146,395 residents on 1 January 2026 and the two largest international schools in the city: the British School of Amsterdam at Havenstraat 6, in a converted nineteenth-century Huis van Bewaring opened in April 2021 with room for 1,200, and the south campus of the Amsterdam International Community School at Arent Janszoon Ernststraat 1179 since 2022. The Zuidas is here too.' },
          { h3: 'Zuidoost', p: 'The district where the test most often came out above the advice: 33 percent of pupils in 2024/25 against a city average of 20. The AICS south-east campus moved to the Sand Castle on the Bijlmerplein in September 2023, and the district is projected to add 33,200 residents by 2055.' },
          { h3: 'Noord', p: 'Connected to the centre by the Noord/Zuidlijn since 22 July 2018, 9.7 kilometres and eight stations from Noord to Station Zuid. Second highest share of higher test advice at 30 percent, and projected growth of 37,200, the second largest in the city.' },
          { h3: 'Oost', p: 'The fastest growing district on paper, plus 42,500 by 2055, and home to Amsterdam Science Park: seventy hectares, about 176 companies, the University of Amsterdam\'s Faculty of Science and the AMS-IX internet exchange, with more than 600 network hubs on one former polder.' },
          { h3: 'West and Nieuw-West', p: 'West adds a projected 13,200 and Nieuw-West 31,300, which makes Nieuw-West the largest of the western growth areas. Between them they hold much of the city\'s primary-school-age population, and the largest share of the 244 basisscholen.' },
  ...
  next: {
    ...
    html: '<a class="cg-inline-link" href="/coding-classes-in-amstelveen">Coding classes in Amstelveen</a> covers the municipality on Amsterdam\'s southern edge with the highest share of Indian-origin residents in the country. The <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a> carries the national curriculum picture and the full course list, and <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a> is for the learner who wants to build models. <a class="cg-inline-link" href="/coding-classes-in-amsterdam-centrum">Amsterdam-Centrum</a> is the first of the eight district pages; the other seven follow in this series.',
