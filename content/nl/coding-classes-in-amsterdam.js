...
module.exports = {
  ...
  next: {
    ...
    html: '<a class="cg-inline-link" href="/coding-classes-in-amstelveen">Coding classes in Amstelveen</a> covers the municipality on Amsterdam\'s southern edge with the highest share of Indian-origin residents in the country. The <a class="cg-inline-link" href="/coding-classes-in-netherlands">Netherlands coding hub</a> carries the national curriculum picture and the full course list, and <a class="cg-inline-link" href="/ai-and-machine-learning-classes-in-netherlands">AI and machine learning classes in the Netherlands</a> is for the learner who wants to build models, and the <a class="cg-inline-link" href="/ai-and-python-academy-amsterdam">AI and Python Academy, Amsterdam</a> teaches that building with the kind of public write-up the city publishes for its own algorithms. <a class="cg-inline-link" href="/coding-classes-in-amsterdam-centrum">Amsterdam-Centrum</a> and <a class="cg-inline-link" href="/coding-classes-in-amsterdam-noord">Amsterdam-Noord</a> and <a class="cg-inline-link" href="/coding-classes-in-amsterdam-oost">Amsterdam-Oost</a> and <a class="cg-inline-link" href="/coding-classes-in-amsterdam-zuid">Amsterdam-Zuid</a> and <a class="cg-inline-link" href="/coding-classes-in-amsterdam-west">Amsterdam-West</a> are the first five of the eight district pages; <a class="cg-inline-link" href="/coding-classes-in-amsterdam-nieuw-west">Amsterdam Nieuw-West</a> and <a class="cg-inline-link" href="/coding-classes-in-amsterdam-zuidoost">Amsterdam-Zuidoost</a> and <a class="cg-inline-link" href="/coding-classes-in-weesp">Weesp</a> complete the set: all eight are now written.',
