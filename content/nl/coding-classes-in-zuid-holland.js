...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Haaglanden: the ring around the capital', p: '<a class="cg-inline-link" href="/coding-classes-in-zoetermeer">Zoetermeer</a> 130,836, third in the province by a margin of 508 over Leiden, with its own page; <a class="cg-inline-link" href="/coding-classes-in-westland">Westland</a> 118,874, the glasshouse municipality, with its own page; <a class="cg-inline-link" href="/coding-classes-in-delft">Delft</a> 110,089, the technical university, with its own page; Leidschendam-Voorburg 78,916; Lansingerland 66,633; Rijswijk 61,857; Pijnacker-Nootdorp 58,741; Wassenaar 27,975; Midden-Delfland 19,355.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Zuid-Holland towns get their own page, and which are covered here?', a: 'Rotterdam, The Hague, Leiden, Delft, Zoetermeer, Dordrecht, Westland, Alphen aan den Rijn, Nissewaard and Schiedam have pages already. Gouda, Vlaardingen, Leidschendam-Voorburg, Capelle, Wassenaar, Voorschoten, Oegstgeest and Rijswijk follow in this series. Every other municipality appears above with its population, and the class a family books from Hillegom is the class a family books from Rotterdam.' },
