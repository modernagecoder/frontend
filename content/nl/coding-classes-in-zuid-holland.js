...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Leiden and the Duin- en Bollenstreek', p: '<a class="cg-inline-link" href="/coding-classes-in-leiden">Leiden</a> 130,328, the university city, with its own page; Katwijk 67,149; Noordwijk 46,453; Teylingen 38,739; Kaag en Braassem 29,467; Leiderdorp 27,973; Oegstgeest 26,095; <a class="cg-inline-link" href="/coding-classes-in-voorschoten">Voorschoten</a> 25,975, with its own page; Lisse 23,842; Hillegom 23,078; Zoeterwoude 10,355. The flower fields are between the towns, and the international school families of the Leiden ring are among the most concentrated in the country.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Zuid-Holland towns get their own page, and which are covered here?', a: 'Rotterdam, The Hague, Leiden, Delft, Zoetermeer, Dordrecht, Westland, Alphen aan den Rijn, Nissewaard, Schiedam, Leidschendam-Voorburg, Gouda, Vlaardingen, Capelle aan den IJssel, Wassenaar and Voorschoten have pages already. Oegstgeest and Rijswijk follow in this series. Every other municipality appears above with its population, and the class a family books from Hillegom is the class a family books from Rotterdam.' },
