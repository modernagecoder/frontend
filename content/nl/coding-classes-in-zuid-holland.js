...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Haaglanden: the ring around the capital', p: '<a class="cg-inline-link" href="/coding-classes-in-zoetermeer">Zoetermeer</a> 130,836, third in the province by a margin of 508 over Leiden, with its own page; <a class="cg-inline-link" href="/coding-classes-in-westland">Westland</a> 118,874, the glasshouse municipality, with its own page; <a class="cg-inline-link" href="/coding-classes-in-delft">Delft</a> 110,089, the technical university, with its own page; <a class="cg-inline-link" href="/coding-classes-in-leidschendam-voorburg">Leidschendam-Voorburg</a> 78,916, with its own page; Lansingerland 66,633; <a class="cg-inline-link" href="/coding-classes-in-rijswijk">Rijswijk</a> 61,857, with its own page; Pijnacker-Nootdorp 58,741; <a class="cg-inline-link" href="/coding-classes-in-wassenaar">Wassenaar</a> 27,975, with its own page; Midden-Delfland 19,355.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Zuid-Holland towns get their own page, and which are covered here?', a: 'Rotterdam, The Hague, Leiden, Delft, Zoetermeer, Dordrecht, Westland, Alphen aan den Rijn, Nissewaard, Schiedam, Leidschendam-Voorburg, Gouda, Vlaardingen, Capelle aan den IJssel, Wassenaar, Voorschoten, Oegstgeest and Rijswijk have pages already. Every other municipality appears above with its population, and the class a family books from Hillegom is the class a family books from Rotterdam.' },
