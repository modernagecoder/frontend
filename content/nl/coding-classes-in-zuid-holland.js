...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'Rijnmond: the ring around the port', p: '<a class="cg-inline-link" href="/coding-classes-in-nissewaard">Nissewaard</a> 89,112, with its own page; <a class="cg-inline-link" href="/coding-classes-in-schiedam">Schiedam</a> 81,931, with its own page; <a class="cg-inline-link" href="/coding-classes-in-vlaardingen">Vlaardingen</a> 77,480, with its own page; Voorne aan Zee 75,012; Capelle aan den IJssel 69,698; Barendrecht 48,701; Ridderkerk 48,084; Maassluis 37,125; Krimpen aan den IJssel 29,864; Albrandswaard 26,559. Ten municipalities that share Rotterdam\'s metro, its port and its river, and not its page.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Zuid-Holland towns get their own page, and which are covered here?', a: 'Rotterdam, The Hague, Leiden, Delft, Zoetermeer, Dordrecht, Westland, Alphen aan den Rijn, Nissewaard, Schiedam, Leidschendam-Voorburg, Gouda and Vlaardingen have pages already. Capelle, Wassenaar, Voorschoten, Oegstgeest and Rijswijk follow in this series. Every other municipality appears above with its population, and the class a family books from Hillegom is the class a family books from Rotterdam.' },
