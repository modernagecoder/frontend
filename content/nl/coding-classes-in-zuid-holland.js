...
module.exports = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Zuid-Holland towns get their own page, and which are covered here?', a: 'Rotterdam, The Hague, Leiden, Delft, Zoetermeer, Dordrecht, Westland, Alphen aan den Rijn, Nissewaard, Schiedam, Leidschendam-Voorburg, Gouda, Vlaardingen, Capelle aan den IJssel and Wassenaar have pages already. Voorschoten, Oegstgeest and Rijswijk follow in this series. Every other municipality appears above with its population, and the class a family books from Hillegom is the class a family books from Rotterdam.' },
