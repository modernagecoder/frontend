...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Leiden and the Duin- en Bollenstreek', p: '<a class="cg-inline-link" href="/coding-classes-in-leiden">Leiden</a> 130,328, the university city, with its own page; Katwijk 67,149; Noordwijk 46,453; Teylingen 38,739; Kaag en Braassem 29,467; Leiderdorp 27,973; <a class="cg-inline-link" href="/coding-classes-in-oegstgeest">Oegstgeest</a> 26,095, with its own page; <a class="cg-inline-link" href="/coding-classes-in-voorschoten">Voorschoten</a> 25,975, with its own page; Lisse 23,842; Hillegom 23,078; Zoeterwoude 10,355. The flower fields are between the towns, and the international school families of the Leiden ring are among the most concentrated in the country.' },
          { h3: 'Haaglanden: the ring around the capital', p: '<a class="cg-inline-link" href="/coding-classes-in-zoetermeer">Zoetermeer</a> 130,836, third in the province by a margin of 508 over Leiden, with its own page; <a class="cg-inline-link" href="/coding-classes-in-westland">Westland</a> 118,874, the glasshouse municipality, with its own page; <a class="cg-inline-link" href="/coding-classes-in-delft">Delft</a> 110,089, the technical university, with its own page; <a class="cg-inline-link" href="/coding-classes-in-leidschendam-voorburg">Leidschendam-Voorburg</a> 78,916, with its own page; Lansingerland 66,633; Rijswijk 61,857; Pijnacker-Nootdorp 58,741; <a class="cg-inline-link" href="/coding-classes-in-wassenaar">Wassenaar</a> 27,975, with its own page; Midden-Delfland 19,355.' },
          { h3: 'Rijnmond: the ring around the port', p: '<a class="cg-inline-link" href="/coding-classes-in-nissewaard">Nissewaard</a> 89,112, with its own page; <a class="cg-inline-link" href="/coding-classes-in-schiedam">Schiedam</a> 81,931, with its own page; <a class="cg-inline-link" href="/coding-classes-in-vlaardingen">Vlaardingen</a> 77,480, with its own page; Voorne aan Zee 75,012; <a class="cg-inline-link" href="/coding-classes-in-capelle-aan-den-ijssel">Capelle aan den IJssel</a> 69,698, with its own page; Barendrecht 48,701; Ridderkerk 48,084; Maassluis 37,125; Krimpen aan den IJssel 29,864; Albrandswaard 26,559. Ten municipalities that share Rotterdam\'s metro, its port and its river, and not its page.' },
          { h3: 'The Drechtsteden and the Alblasserwaard', p: '<a class="cg-inline-link" href="/coding-classes-in-dordrecht">Dordrecht</a> 122,991, fifth in the province, with its own page; Molenlanden 45,625, with the Kinderdijk mills; Zwijndrecht 44,819; Gorinchem 39,060; Hendrik-Ido-Ambacht 33,100; Papendrecht 32,267; Sliedrecht 26,531; Alblasserdam 20,250; Hardinxveld-Giessendam 19,402. Shipyards, rivers and a city older than either of the big two.' },
          { h3: 'The Groene Hart', p: '<a class="cg-inline-link" href="/coding-classes-in-alphen-aan-den-rijn">Alphen aan den Rijn</a> 117,284, seventh in the province, with its own page; <a class="cg-inline-link" href="/coding-classes-in-gouda">Gouda</a> 77,818, with its own page; Krimpenerwaard 57,898; Zuidplas 49,291; Bodegraven-Reeuwijk 37,291; Waddinxveen 35,542; Nieuwkoop 29,728. The open middle of the Randstad, whose whole planning purpose is to stay open.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Zuid-Holland towns get their own page, and which are covered here?', a: 'Rotterdam, The Hague, Leiden, Delft, Zoetermeer, Dordrecht, Westland, Alphen aan den Rijn, Nissewaard, Schiedam, Leidschendam-Voorburg, Gouda, Vlaardingen, Capelle aan den IJssel, Wassenaar, Voorschoten and Oegstgeest have pages already. Rijswijk follows in this series. Every other municipality appears above with its population, and the class a family books from Hillegom is the class a family books from Rotterdam.' },
