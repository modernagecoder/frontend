...
module.exports = {
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          ...
          { h3: 'The Heuvelrug and the Gelderse Vallei', p: '<a class="cg-inline-link" href="/coding-classes-in-veenendaal">Veenendaal</a> 70,779, third in the province, with its own page; Utrechtse Heuvelrug 51,107, the wooded ridge; Rhenen 20,457; Renswoude 5,908, the smallest municipality. The Heuvelrug is the one part of the province with anything that could be called a hill.' },
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which towns in the province get their own page, and which are covered here?', a: 'Utrecht city, Amersfoort and Veenendaal have pages already. The other 23, from Nieuwegein and Zeist to Oudewater, Eemnes and Renswoude, are listed above with their populations; the class is identical wherever the laptop is.' },
