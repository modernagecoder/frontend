...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        { kind: 'p', text: 'All 31 are above. Maastricht, Venlo, Sittard-Geleen and Heerlen already have city pages that go close, and Roermond will follow; this one stays at the scale where Mook and Vaals are both in view.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Limburg towns get their own page, and which are covered here?', a: 'Maastricht, Venlo, Sittard-Geleen and Heerlen have theirs already, all linked above, and Roermond follows in this series. The other 26, from Weert and Kerkrade to Mook en Middelaar, are listed above with their populations, and the class is the same one whichever of them the laptop is in.' },
