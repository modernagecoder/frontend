...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Zuid-Limburg: the cities', p: 'Maastricht 126,026, the capital, a page to come; Sittard-Geleen 92,461, a page to come; Heerlen 87,764, a page to come; Kerkrade 45,824; Landgraaf 36,844; Beekdaelen 35,903; Brunssum 27,474; Stein 24,691. The old mining belt and the university city, within half an hour of each other.' },
          ...
          { h3: 'Midden-Limburg', p: 'Roermond 61,431, a page to come; Weert 51,498; Leudal 36,099; Echt-Susteren 32,385; Maasgouw 24,377; Roerdalen 20,995; Nederweert 17,533. The Maas valley and the lakes, between the two halves that do most of the talking.' },
          { h3: 'Noord-Limburg', p: 'Venlo 104,195, the second city, a page to come; Peel en Maas 45,816; Venray 45,108; Horst aan de Maas 44,821; Gennep 17,953; Beesel 13,579; Bergen 13,037; Mook en Middelaar 8,192, the smallest and the furthest north, closer to Nijmegen than to any Limburg city.' },
        ...
        { kind: 'p', text: 'All 31 are above. The city pages for Maastricht, Venlo, Sittard-Geleen, Heerlen and Roermond will go close; this one stays at the scale where Mook and Vaals are both in view.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Limburg towns get their own page, and which are covered here?', a: 'Maastricht, Venlo, Sittard-Geleen, Heerlen and Roermond follow in this series. The other 26, from Weert and Kerkrade to Mook en Middelaar, are listed above with their populations, and the class is the same one whichever of them the laptop is in.' },
