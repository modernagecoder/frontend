...
module.exports = {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Overijssel towns get their own page, and which are covered here?', a: 'Enschede, Zwolle and Deventer already have theirs, linked above, and Almelo follows in this series, and Hengelo has its page. The other twenty, from Hardenberg and Kampen to Staphorst, are listed above with their populations, and the class booked from any of them is the same class.' },
