...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        { kind: 'p', text: 'Twenty-five, and every one is above. This page is deliberately wide; the pages for Enschede, Zwolle, Deventer, Hengelo and Almelo will each go close.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Overijssel towns get their own page, and which are covered here?', a: 'Enschede, Zwolle, Deventer, Hengelo and Almelo follow in this series. The other twenty, from Hardenberg and Kampen to Staphorst, are listed above with their populations, and the class booked from any of them is the same class.' },
