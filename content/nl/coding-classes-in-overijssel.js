...
module.exports = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        { kind: 'grid3', cells: [
          { h3: 'Twente, the cities', p: '<a class="cg-inline-link" href="/coding-classes-in-enschede">Enschede</a> 162,683, the largest, with its own page; <a class="cg-inline-link" href="/coding-classes-in-hengelo">Hengelo</a> 84,045, with its own page; Almelo 75,166, a page to come; Oldenzaal 32,033; Borne 25,038. The technical university, Saxion, the former mills and the international school at Enschede.' },
        ...
        { kind: 'p', text: 'Twenty-five, and every one is above. This page is deliberately wide; Enschede, Zwolle, Deventer and Hengelo already have pages that go close, and Almelo will follow.' }
      ]
    },
    {
  ...
  faq: {
    ...
    items: [
      ...
      { q: 'Which Overijssel towns get their own page, and which are covered here?', a: 'Enschede, Zwolle, Deventer and Hengelo already have theirs, linked above, and Almelo follows in this series. The other twenty, from Hardenberg and Kampen to Staphorst, are listed above with their populations, and the class booked from any of them is the same class.' },
