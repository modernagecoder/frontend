...
document.addEventListener('input', function(e) {
    ...
    // This capped EVERY country at ten digits, whatever the picker said. A
    // visitor from China (11 digits), Germany (up to 12) or Sweden (up to 13)
    // had the end of their number silently deleted as they typed it, and the
    ...
    // dropdown gets it taken off the front rather than losing the end - but
    // only when the number is not already valid, so a ten-digit Indian mobile
    // beginning 91 is never touched.
    //
