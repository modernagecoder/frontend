...
class FormValidator {
  ...
  onValidSubmit() {
    ...
    this.showFormMessage('Form submitted successfully! We will reach out within 48 hours. To connect now, you can contact 9123366161 (Shivam Sir) directly for a faster response.', 'success');
