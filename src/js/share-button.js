 ...
 * Adds share functionality with copy URL and social media sharing
 */
...
class ShareButton {
    ...
    createShareButton() {
        ...
        if (document.querySelector('.share-button-container')) return;

        const shareHTML = `
            <div class="share-button-container">
                <button class="share-button" id="shareButton" aria-label="Share this page">
        ...
        // Try to insert after the hero title or at the top of main content
        const heroContent = document.querySelector('.course-hero-content, .blog-hero-content, .hero-content');
        const mainContent = document.querySelector('main');
        
        if (heroContent) {
            heroContent.insertAdjacentHTML('beforeend', shareHTML);
        } else if (mainContent) {
            mainContent.insertAdjacentHTML('afterbegin', shareHTML);
        } else {
    ...
    createToast() {
        if (document.querySelector('.share-toast')) return;
