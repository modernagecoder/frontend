...
Worked example · the area modelCompute 23 × 14.
...
**How our mentor teaches it:** draw the rectangle. 23 becomes 20 + 3 across the top; 14 becomes 10 + 4 down the side. Four regions appear, and the child computes each one:
 ...
 20 +3 +----------+-----+10 | 200 | 30 | +----------+-----+ 4 | 80 | 12 | +----------+-----+200 + 30 + 80 + 12 = 322
...
[Watch real recorded classes](/how-we-teach)The complete grade 4 map
...
Worked example · interpreting remainders245 students are going on a field trip.Each bus holds 40 students.How many buses does the school need?
...
245 ÷ 40 → 6 full buses + 5 students left overContext says: those 5 still need a seatAnswer: 7 buses
...
One more, because fractions

## Comparing 2/3 and 3/5 without a common-denominator ritual.

Worked example · benchmark reasoningWhich is greater: 2/3 or 3/5?
...
2/3 = 1 − 1/3 (missing one piece of size 1/3)3/5 = 1 − 2/5 (missing two pieces of size 1/5)1/3 < 2/5 → 2/3 is closer to 1 → 2/3 > 3/5
