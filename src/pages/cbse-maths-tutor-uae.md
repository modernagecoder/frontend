...
We follow the NCERT chapters and your child's school approach, so tuition supports class, not competes with it.
...
Previous-year papers, sample papers and the current exam pattern, with the presentation that earns full marks.

### Strengthen toward what's next

For students aiming at JEE or other competitive exams, we build the deeper foundations early.
...
## Understanding-based maths is the foundation of coding, AI and engineering.
...
A multi-step board question and a software task are solved the same way: decompose, then build up.
...
## CBSE & ICSE maths, Class 6 to 12.

NCERT-aligned, with the board exams firmly in view.
...
Relations and functions, trigonometry, limits and calculus, vectors, probability and the full Class 12 board syllabus.

### Board exam preparation

Previous-year and sample papers, competency-based and case-study questions, and full-marks presentation.

### ICSE maths

The ICSE syllabus and exam style for families on that board, taught the same understanding-first way.

### Competitive foundations

For JEE-bound students, the deeper conceptual base that competitive exams reward, started early.
...
**What's realistic.** Understanding rebuilds within a few weeks; board-level marks track a term or two of steady work. We'll set an honest target around your child's class and timeline, and never guarantee a percentage.

### What we won't do

- Hand over NCERT solutions to be memorised.
- Drill patterns without building understanding.
- Guarantee a specific board percentage.
- Ignore the new competency-based question styles.

How lessons work

## Built around the Indian-school calendar in the UAE.

### 1:1, live

One student, one tutor who knows CBSE/ICSE, real-time video with a shared whiteboard.

### 8 sessions a month

Two each week, worked from NCERT and your child's school.
...
Focused previous-year-paper practice before the Class 10/12 boards.
...
## Book a free CBSE maths trial session.

Tell us your child's class and board, and where they're stuck. We'll match a CBSE/ICSE tutor, show you how we teach, and you decide. No card needed.
