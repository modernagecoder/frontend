...
LIVE ONLINE · CODING & MATHS · SALT LAKE, KOLKATA
...
Classes happen live, with a real engineer or maths graduate teaching you directly. You ask a question and get an answer in the same minute, not in a comments thread three days later. Nothing here is a playback of someone else's lesson.

### Small premium batches

Group batches cap at 6-8 students, mini batches at 3-4, and 1-on-1 is exactly that. The teacher sees every screen, knows every name, and notices the moment a concept slips. This is the opposite of a packed Sector V seminar hall.

### Taught by working engineers

Your child learns from full-time software engineers and qualified maths graduates, not part-time college students reading from a slide deck. Salt Lake parents who lead data and engineering teams in Sector V recognise the difference in the first ten minutes of a demo.
...
Coursework maps directly to what Salt Lake schools actually teach: ICSE Java/BlueJ for St. Francis Xavier and Sri Sri Academy, CBSE Python for KV No. 1 and DPS Megacity, plus IGCSE. Classwork reinforces the syllabus instead of competing with it. See [ICSE Java & CBSE Python](/courses/cbse-icse-computer-science-class-11-12-python-java-complete-course).
...
## Every track we teach, near Salt Lake
...
| [AI/ML Course for College Students](/ai-ml-course-for-college-students) | College & serious learners | College-level model building and applied projects |
...
## Three tracks Salt Lake families ask for most
...
## Built around Salt Lake's ICSE and CBSE schools

Modern Age Coders teaches students from the major schools across Salt Lake and Bidhannagar, including Sri Sri Academy, St. Francis Xavier School (Sector III), St. Joan's School, Salt Lake School, Salt Lake Point School, Lakshmipat Singhania Academy and Holy Child Institution on the ICSE side, and Kendriya Vidyalaya No. 1 (Sector I), Apeejay School Salt Lake (Sector II), Hariyana Vidya Mandir, Adamas International and DPS Megacity on the CBSE side. Whichever school and board your child is on, classes fit alongside it.

Salt Lake is an ICSE-heavy neighbourhood with a strong CBSE presence, and our curriculum respects that split: ICSE students get Java/BlueJ aligned to Computer Applications, while CBSE students get Python aligned to Computer Science and Informatics Practices. For board years, our [Computer Science for Class 11-12 (ICSE Java & CBSE Python)](/courses/cbse-icse-computer-science-class-11-12-python-java-complete-course) and [ICSE Class 10 Computer Applications](/computer-applications-icse-class-10) tracks cover theory, practicals, projects and exam preparation in one place. IGCSE students are covered too via [Coding for IGCSE students](/coding-for-igcse-students).
...
### Block-wise Garbage Pickup Reminder

A Class 8 student in CD Block built a Python script that pings the family's phone on their block's scheduled BMC waste-collection day, after noticing the truck timings differed sector to sector.

PROJECT B

### Sector V Shuttle Fare Splitter

A Class 10 student whose mother shares an office shuttle into Sector V wrote a Python app that splits the monthly pool-car fare across changing riders and tracks who owes whom.

PROJECT C

### City Centre Parking-Slot Estimator
...
## Across Salt Lake, Bidhannagar and the Sector V belt

Serving Salt Lake and Bidhannagar pin codes **700064, 700091, 700101, 700102, 700105, 700106** and **700156**, plus the wider Sector V and City Centre belt.
...
## Slots that flex around Sector V office hours

| Slot | Time | Best for | Days |
| --- | --- | --- | --- |
| Early Morning | 6:30-8:00 AM | Before-school kids; pre-office parents | Mon-Fri |
...
- Easy to schedule around late office hours and shuttle timings
