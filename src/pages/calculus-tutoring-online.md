...
Worked example · what f′ actually isA ball's height is h(t) = 100 − 5t² meters after t seconds.How fast is it falling at exactly t = 2?
...
[2, 2.1]: avg speed = −20.5 m/s[2, 2.01]: avg speed = −20.05 m/s[2, 2.001]: avg speed = −20.005 m/sThe answers are APPROACHING −20. That target is the derivative.
...
[Watch real recorded classes](/how-we-teach)The complete first-year calculus map
...
AB, BC and college syllabi weight these differently; the mentor matches your student's actual course. For the AP exam itself, pacing, scoring, calculator strategy, see our dedicated [AP Calculus page](/ap-calculus-tutoring-online).

The calculus wall

## The chain rule, taught as the onion it is.

Worked example · d/dx of sin(x³)Differentiate f(x) = sin(x³).
...
layers: sin( [x³] )outer layer: sin(·) → cos(·), keep the inside: cos(x³)inner layer: x³ → 3x²f′(x) = cos(x³) · 3x²
...
AP students shift to exam pacing with our [AP track](/ap-calculus-tutoring-online); college students align to midterms. Monthly billing throughout.
...
[The AP examAP Calculus AB & BC](/ap-calculus-tutoring-online)[The course beforePrecalculus Tutoring](/precalculus-tutoring-online)[FoundationsAlgebra 2 Tutoring](/algebra-2-tutoring-online)[CourseCollege Mathematics Masterclass](/courses/college-mathematics-complete-masterclass)[Behind at schoolMath Catch-Up Program](/math-catch-up-program)[Ranked guideBest Online Math Tutoring 2026](/best-online-math-tutoring-2026)
