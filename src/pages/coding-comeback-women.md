...
Reserve a seat in the next cohort →See the 18-week arcCohort 04 graduate
...
Best for · women with prior IT, engineering or CS rolesPath 02 · For the analyst & consultant
...
Best for · MBAs, CAs, ex-Big-Four, banking, ops, marketingPath 03 · For the new-to-code
...
Best for · women coming from non-tech backgrounds entirelyPath 04 · For the AI curious
...
Best for · women who want income before they want employmentThe arc · 18 weeks · three phases
...
**Cohort 02 graduate · age 38 · Bangalore**Backend engineer, Series-B SaaS company
...
**Cohort 03 graduate · age 51 · Pune**Independent AI automation consultant
...
**Cohort 04 graduate · age 34 · Surat**Freelance data analyst
...
**Cohort 01 graduate · age 42 · Dubai**Senior data engineer, Singapore fintechSix courses · adult-paced · women-only cohorts available
...
[Path · Full Beginner / Rebuild Python Programming *Masterclass* From "I have never installed Python" to shipping a real working web application. The most-taken first course for women on the rebuild and full-beginner paths. Weekly live · 2 classes₹1,499/mo](/courses/python-programming-masterclass-zero-to-advanced-college)[Path · Data & Analytics Data Science *Complete* Python data stack — Pandas, NumPy, scikit-learn, Matplotlib. Designed for ex-consultants, ex-MBAs and analysts. By month four most women are taking freelance dashboard work. Weekly live · 2 classes₹1,499/mo](/courses/data-science-complete-masterclass-college)[Path · Rebuild Engineer Full-Stack Web *Development* For the engineer who left tech in 2018 and wants to come back as a full-stack hire by 2027. React, Node, modern tooling, deploy pipelines, real portfolio. Weekly live · 2 classes₹1,499/mo](/courses/full-stack-web-development-masterclass-college)[Path · AI Tools Fast Track AI Tools *Mastery* The shortest path to a paying skill in 2026. Claude, ChatGPT, Cursor, n8n, Zapier. Many women on this path are earning freelance income before the cohort ends. Weekly live · 2 classes₹1,499/mo](/courses/ai-tools-mastery-complete-college)[Path · Data Light Data Analysis *Mastery* The lighter cousin of the full data-science track. SQL, dashboards, applied stats, Power BI & Tableau. Built for ex-finance, ex-operations, ex-audit professionals. Weekly live · 2 classes₹1,499/mo](/courses/data-analysis-mastery-course-college)[Path · Modern AI Builder Generative AI *Masterclass* Build with the LLMs, not around them. Custom GPTs, RAG, agent design, multi-tool workflows. Highest-leverage course for a woman who wants to be a modern AI engineer. Weekly live · 2 classes₹1,499/mo](/courses/complete-generative-ai-masterclass-college)Cohorts open every quarter · 24 seats
...
The full track is priced as an 18-week programme with a single fee, payable in three instalments. Full transparent pricing is on our [pricing page](/pricing) or via the [fee calculator](/coding-fee-calculator). We run a quiet scholarship for women in financial difficulty, single mothers, and women coming out of caregiving roles for elderly parents or special-needs children. There is no application form for the scholarship — we discuss it on the orientation call. We are not loud about it. It is simply available.

I am abroad — does this work outside India?

Yes. About 30% of our comeback cohort lives outside India. Class slots are scheduled in your local time zone (you pick one of three options at enrolment). Country-specific information lives on our pages for [USA](/coding-classes-in-united-states), [UK](/coding-classes-in-united-kingdom), [Canada](/coding-classes-in-canada), [UAE](/coding-classes-in-uae), [Singapore](/coding-classes-in-singapore), [Australia](/coding-classes-in-australia), [Germany](/coding-classes-in-germany), [Sweden](/coding-classes-in-sweden), [Switzerland](/coding-classes-in-switzerland), [Ireland](/coding-classes-in-ireland) and [New Zealand](/coding-classes-in-new-zealand).

What is the difference between this and the regular "coding classes for girls" page?

Our [coding classes for girls](/coding-classes-for-girls) page is for school-going girls — ages 8 to 17. This page is for adult women returning to or entering the workforce. The pedagogy, pace, peer group and outcomes are different. If you are a parent thinking about your daughter, the other page is the right one. If you are thinking about yourself, you are in the right place.

## If this was for you, these *might also be.*

#### Adult tracks

[Summer camp · adults](/summer-coding-camp-adults)[Winter camp · adults](/winter-coding-camp-adults)[Coding for professionals](/levels/coding-for-professionals)[AI agents & automation](/ai-agents-and-automation)

#### Tools to start

[Screen-time to skill](/screen-time-to-skill)[Fee calculator](/coding-fee-calculator)[Full coding roadmap](/coding-roadmap)[Book a free demo](/book-demo)

#### Languages

[Python & AI](/python-and-ai-classes-for-kids-teens)[Java](/java-programming-for-kids-teens)[AI & ML](/ai-ml-course-for-teens)[All online classes](/best-coding-classes-online)

#### Around the world

[USA](/coding-classes-in-united-states)[UK](/coding-classes-in-united-kingdom)[Canada](/coding-classes-in-canada)[UAE](/coding-classes-in-uae)
