...
100% Live, never recordedBatches of 3–8 studentsFull-time engineers & maths graduatesFree demo, no commitment3–8Students per live batch1-on-1Personalised option6–67Ages we teach~60 minSaved each class, no commute[Book Free Demo Class](/book-demo)[Explore Courses](/courses)LIVE ONLINE · GARIAHAT, KOLKATA

## At a glance

Format**100% live online**, small-batch, project-based — never pre-recordedBatch sizeGroup (max 6–8), Mini Batch (3–4), or 1-on-1Ages6 to 67 — kids, teens, college students and adultsSubjectsCoding (Python, Java, AI/ML, web, DSA) and Maths (school to Olympiad)BoardsCBSE, ICSE/ISC and WBBSE — including ICSE Computer Applications (Java/BlueJ)FeesFrom **₹1,499/month** (group), ₹2,999/month (mini batch), ₹4,999/month (1-on-1)Free demoYes — one free live demo class, no commitmentServingGariahat, Ekdalia, Hindustan Park, Mandeville Gardens, Bondel Road, Kankulia, Ballygunge & all of South KolkataLIVE ONLINE · GARIAHAT, KOLKATA
