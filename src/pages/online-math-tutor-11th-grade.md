...
Juniors in precalculus or AP Calculus run the same campaign shape with different content, our [precalculus](/precalculus-tutoring-online) and [AP Calculus](/ap-calculus-tutoring-online) pages cover those roads in depth.

Watch the method work

## One technique, two exams: completing the square.

From a real 11th grade lesson · the double-pay hour in actionAlgebra 2 test, Friday: write y = x² + 6x + 2 in vertex formx² + 6x + 2 → (x + 3)² - 7 → vertex (-3, -7)SAT, May: find the center of the circle x² + y² + 6x - 4y = 12(x + 3)² + (y - 2)² = 25 → center (-3, 2), radius 5
...
[Watch real recorded classes](/how-we-teach)How we run a junior year
...
Junior year rewards coherence over heroics. Watch the difference in a real class: the demo is free. [See exactly how we teach →](/how-we-teach)
...
[See the SAT course](/courses/sat-math-prep-course)
...
[The rung below10th Grade Math Tutoring](/online-math-tutor-10th-grade)[The rung above12th Grade Math Tutoring](/online-math-tutor-12th-grade)[The course, in depthAlgebra 2 Tutoring](/algebra-2-tutoring-online)[The test, in depthSAT Math Tutoring](/sat-math-tutoring-online)[CourseSAT Math 800 Prep](/courses/sat-math-prep-course)[Ranked guideBest Online Math Tutoring 2026](/best-online-math-tutoring-2026)
