...
Worked example · AA-style non-calculator questionSolve 22x - 5·2x + 4 = 0
...
y² - 5y + 4 = 0(y - 1)(y - 4) = 0 → y = 1 or y = 42x = 1 → x = 0 · 2x = 4 → x = 2
...
One more, from the AI side

## An AI-style modelling question, where interpretation is the mark.

Worked example · AI-style exponential modelA cup of coffee cools in a 20°C room. Its temperature is modelled byT(t) = 20 + 60e-0.1t (t in minutes)(a) State the initial temperature. (b) Explain the meaning of the 20. (c) Find when the coffee reaches 40°C.
...
(c) 40 = 20 + 60e-0.1te-0.1t = 20/60 = 1/3-0.1t = ln(1/3) → t = 10 ln 3 ≈ 11.0 minutes(or solved graphically on the GDC, which AI papers fully accept)
...
IB students tell us these classes are the hour their week organizes around. Watch one before believing us: the demo is free. [See exactly how we teach →](/how-we-teach)
...
[IB in the UAEIB Maths Tutor, UAE](/ib-maths-tutor-uae)[Before the DPIGCSE Maths Tuition](/igcse-maths-tuition-online)[CourseHigh School Mathematics Mastery Program](/courses/complete-high-school-mathematics-mastery)[CourseOlympiad & Competition Mathematics](/courses/olympiad-competition-mathematics-mastery)[Calculus depthCalculus Tutoring Online](/calculus-tutoring-online)[Ranked guideBest Online Math Tutoring 2026](/best-online-math-tutoring-2026)
