...
100% Live, Not RecordedSmall Batches (6–8)Taught by Full-Time EngineersFrom ₹1,499/month[Book a Free Demo Class](/book-demo)[Explore All Courses](/courses)6–8Students per live batch1:1Personalised option4.9/5Parent rating24 hrsDemo to first classLive Online · Lake Gardens, Kolkata

## At a glance

Format**100% live online**, real-time with a teacher — never pre-recordedBatch sizeGroup max 6–8, Mini Batch 3–4, or 1-on-1 personalisedAges6 to 18 for school tracks; college and working professionals also taught (6 to 67)SubjectsCoding (Python, Java, Scratch, AI/ML, web, DSA) + Mathematics (Grade 1 to college)BoardsICSE, CBSE, ISC, IGCSE and WBBSE — Java for ICSE, Python for CBSEFeesGroup from ₹1,499/month; Mini Batch ₹2,999/month; 1-on-1 ₹4,999/monthFree demoA full live class, not a sales call; classes can start within 24 hoursServingLake Gardens (700045) and Jodhpur Park, Dhakuria, Tollygunge, Charu Market, Kalighat, Golf GreenWhy Live, Why Small
...
For most Lake Gardens families — laptop at home, broadband already on, a child who is academically driven but over-scheduled — live online wins on every count that matters. Try a [free demo](/book-demo) and judge it for yourself.
...
Choose the right course and a plan that fits — group from ₹1,499, Mini Batch ₹2,999, or 1-on-1 at ₹4,999.
...
*DSonam OswalWorking Professional*
