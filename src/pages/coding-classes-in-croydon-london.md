...
[Home](/) / [United Kingdom](/coding-classes-in-united-kingdom) / [London](/best-coding-class-in-london) / Croydon

London Borough of Croydon / Live online

# Coding classes in Croydon
...
- [Scratch Coding for Kids](/courses/scratch-programming-complete-course) (Ages 6 to 10): A Scratch penalty game with a score table that sorts itself, and a first taste of rules deciding a winner.
- [Python and AI for Kids](/courses/python-ai-kids-masterclass) (Ages 9 to 12): First Python: read a list of results, add up points, and sort teams into a table.
- [Python for Teens](/courses/python-complete-masterclass-teens) (Ages 13 to 18): Python for Key Stages 3 to 5, including this page's Bradley-Terry ranking and the test on a new season.
- [Data and AI Analytics for Non-Programmers (Excel, Sheets, Power BI)](/courses/data-and-ai-analytics-for-non-programmers-course) (Adults): For adults who meet rankings and ratings at work and want to know what they can and cannot predict.
...
**Croydon in figures, each with its publisher**
...
**Points worked out by us from the results**
...
**Predicting the 276 decisive matches of 2025-26, run 25 September 2026**
...
**Log loss per match, draws counted as half, run 25 September 2026**
...
**Croydon and the other boroughs** At the 2021 Census Croydon had more usual residents than any other London borough, just ahead of Barnet. The [London page](/best-coding-class-in-london) lists all 32 and the City, adding a link to each as it goes live, including [Newham](/coding-classes-in-newham-london) across the river in the east.
...
- **Ages 6 to 10: Scores and tables** Children keep score in Scratch games and sort players or teams from most points to fewest. [Scratch Coding for Kids](/courses/scratch-programming-complete-course), [Coding for Kids](/courses/kids-coding-blocks-masterclass)
- **Ages 10 to 13: Results to a table** Python that reads match results, awards points and sorts a league, with ties broken by goal difference. [Python and AI for Kids](/courses/python-ai-kids-masterclass), [Maths Through Coding](/courses/maths-through-coding)
- **Ages 13 to 18: Rank, predict, calibrate** Logistic curves, maximum likelihood and a fair test on new data, rich material for a computing or maths project. [Python for Teens](/courses/python-complete-masterclass-teens), [Full Stack Web Development for Teens](/courses/full-stack-web-development-teens-masterclass)
- **Ages 18 to 67: Ratings at work** Adults learn how rating systems are built and why a confident prediction is not the same as a good one. [Data and AI Analytics for Non-Programmers (Excel, Sheets, Power BI)](/courses/data-and-ai-analytics-for-non-programmers-course), [Python Automation Course](/courses/python-ai-automation-masterclass-college)
...
- **At home** Learners join on a laptop or desktop with headphones and a steady broadband or mobile connection.
- **Key Stages named** Progress is described in the stages used by schools in England, from Key Stage 1 to sixth form, with GCSE and A level mentioned where relevant. All lessons are in English.
- **Free first lesson** A real teaching session rather than a pitch, finishing with a recommended level and course. We never ask for card details at this stage.
- **Five to ten per class** Classmates share a stage of learning and come from across the UK and beyond, which keeps a suitable hour available.
- **Two evenings a week** Classes usually meet twice weekly and pause for half terms, holidays and exams by agreement.
- **London clock** Teachers are based in India, but every lesson time in our messages is given in UK time.

**Nearly 391,000 people, one right class** Croydon alone could fill many classes, yet a good one needs five learners at the same level and the same hour, so ours draw on learners well beyond the borough.

## Fees for Croydon families

A free first lesson, then one monthly fee that is the same from Norbury to New Addington.

- First class: USD 0. A full lesson with a teacher, at no cost, that ends with our recommendation of level, course and time.
- Group tuition: USD 100 a month. Roughly eight live lessons each month in a class of five to ten learners at one stage.
- Private tuition: USD 150 a month. Roughly eight live lessons each month, taught one to one.
...
Book the free class on [https://learn.modernagecoders.com/coding-classes-in-croydon-london](https://learn.modernagecoders.com/coding-classes-in-croydon-london#book), WhatsApp or call +91 91233 66161 (an Indian number, Modern Age Coders' actual contact), or email contact@modernagecoders.com. Rated 4.9 across 547 Google reviews.
