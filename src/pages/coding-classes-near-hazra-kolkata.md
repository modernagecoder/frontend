...
Slots are indicative; we set the final timetable around your child's school and tuition schedule. [Book a demo](/book-demo) to lock a slot.
...
For serious, project-based coding and board-aligned maths, a small live online batch led by an engineer beats both the oversized local tuition room and the well-meaning home tutor who cannot actually code. [See it for yourself in a free demo](/book-demo).
