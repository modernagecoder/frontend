...
Portsmouth, Hampshire / Live online
...
Facts last verified 22 September 2026. Teaching is online; no Portsmouth branch is claimed. 10,000+ students taught, rated 4.9 across 547 Google reviews, teaching since 2020, 25+ countries, ages 6 to 67, 5 to 10 students per group.
...
- [Problem Solving and Computational Thinking for Kids](/courses/problem-solving-and-computational-thinking-for-kids) (Ages 7 to 12): Maps, mazes and puzzles about getting from one place to another, including which single path, if blocked, would stop the journey.
- [Problem Solving for Teens](/courses/problem-solving-dsa-masterclass-teens) (Ages 13 to 18): Graphs, searches and flows built from scratch, the toolkit this page uses on Portsmouth's roads.
- [Competitive Programming for Teens](/courses/competitive-programming-for-teens-course) (Ages 13 to 18): Contest-style problems for teenagers who like hard algorithms, where max-flow and min-cut are standard weapons.
- [Data Structures & Algorithms Course](/courses/data-structures-algorithms-masterclass-college) (University and adult): Interview-level data structures and algorithms for adults, from graph representation to network flow.
...
**Where the roads come from** Ordnance Survey publishes Open Roads as free open data: every public road in Great Britain as a network of links and junctions. In a box around Portsmouth, from Fareham to Havant, it holds 17,738 links, most of them single carriageway, with dual carriageways shown as one collapsed link.
...
**Cuts and routes in the Open Roads network around Portsmouth**
...
**Reading a network result honestly**
...
- **Ages 6 to 10: Ways across** Counting the routes between two places on a simple map and finding which roads, if closed, would stop the trip. [Problem Solving and Computational Thinking for Kids](/courses/problem-solving-and-computational-thinking-for-kids), [Coding for Kids](/courses/kids-coding-blocks-masterclass)
- **Ages 11 to 13: Graphs in code** Storing a map as nodes and edges, walking it with a search, and spotting the links that everything depends on. [Python and AI for Kids](/courses/python-ai-kids-masterclass), [Maths Through Coding](/courses/maths-through-coding)
- **Ages 14 to 18: Flows and cuts** Augmenting paths, the max-flow min-cut theorem and graph bridges on the real Portsmouth road network. [Problem Solving for Teens](/courses/problem-solving-dsa-masterclass-teens), [Competitive Programming for Teens](/courses/competitive-programming-for-teens-course)
- **Ages 18 to 67: Network resilience** Flow algorithms for adults working with networks, logistics and infrastructure, and how to explain a bottleneck. [Data Structures & Algorithms Course](/courses/data-structures-algorithms-masterclass-college), [Python Masterclass](/courses/python-programming-masterclass-zero-to-advanced-college)
...
- **Island and mainland** A learner in Eastney and another in Paulsgrove can share one lesson without either of them using the M275.
- **English stages throughout** Reception, Key Stages 1 to 4, GCSEs and A levels, named as Portsmouth schools name them, and every lesson taught in English.
...
Book the free class on [https://learn.modernagecoders.com/best-coding-class-in-portsmouth](https://learn.modernagecoders.com/best-coding-class-in-portsmouth#book), WhatsApp or call +91 91233 66161 (an Indian number, Modern Age Coders' actual contact), or email contact@modernagecoders.com. Rated 4.9 across 547 Google reviews.
