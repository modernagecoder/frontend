...
description: "Live 1:1 online IB Maths tutoring in the UAE — Analysis & Approaches (AA) and Applications & Interpretation (AI), SL and HL, plus the IA exploration. We teach the concepts, not rote, and coach the GDC and exam papers. Gulf Standard Time. USD 100/month (about AED 370). Free trial."
canonical: https://learn.modernagecoders.com/ib-maths-tutor-uae
keywords: ["IB maths tutor UAE", "IB maths tutor Dubai", "IB maths AA tutor", "IB maths AI tutor", "IB maths HL tutor", "IB maths SL tutor", "IB mathematics analysis and approaches", "applications and interpretation tutor", "IB maths IA help", "IB diploma maths tutor UAE", "MYP maths tutor UAE", "IB maths exam prep Dubai"]
source: src/pages/ib-maths-tutor-uae.html
---
> Live 1:1 online IB Maths tutoring in the UAE — Analysis & Approaches (AA) and Applications & Interpretation (AI), SL and HL, plus the IA exploration. We teach the concepts, not rote, and coach the GDC and exam papers. Gulf Standard Time. USD 100/month (about AED 370). Free trial.
...
We teach the concepts properly, coach the GDC and Paper 1/2/3 technique, and keep the same IB-experienced tutor throughout. Pricing is **USD 100 per month (about AED 370)** for eight 1:1 sessions, lessons run in Gulf Standard Time, and the first session is free.
...
## Concepts first, then communication and exam technique.

Exactly what the IB grade descriptors actually reward.
...
Efficient calculator use and Paper 1, 2 and (HL) Paper 3 practice, building the technique and timing the IB rewards.
...
## IB Maths and computer science reward the same kind of mind.
...
An IB justification and a correctness argument in code are the same skill: saying clearly why a claim holds.
...
## The full IB Maths courses, plus the IA.

AA and AI, SL and HL, taught to your child's exact option.

### Number & algebra

Sequences and series, exponents and logarithms, the binomial theorem, and (HL) proof, complex numbers and systems.

### Functions

Linear, quadratic, exponential, logarithmic and rational functions, transformations, and modelling.

### Geometry & trigonometry

Trig functions and identities, the unit circle, triangle problems, and (HL) vectors.
...
Data, distributions, the normal and binomial models, and the heavier statistical focus of AI.

### The Internal Assessment

Topic choice, mathematical depth, personal engagement, and the assessment criteria for the 20% exploration.
...
**What's realistic.** Conceptual clarity often comes within a few weeks; a grade improvement and a strong IA track the months of steady work between sessions. We'll set an honest target around your child's level and timeline, and never guarantee a 7.

### What we won't do

- Write your child's IA for them.
- Teach methods with no concept underneath.
- Guarantee a specific IB grade.
- Push a course or level that doesn't fit your child.

How lessons work

## Built around the IB calendar.

### 1:1, live

One student, one IB-experienced tutor, real-time video with a shared whiteboard.

### 8 sessions a month

Two each week, around an hour, worked from your child's option and school.
...
Focused support around IA deadlines and the May/November exams.
...
- Concepts, IA support, GDC and past papers
...
| Monthly price | $100 / ≈AED 370 (1:1) | AED 1,500–4,000+ | Free–AED 150 |
...
AA is more algebraic and proof-focused (maths, engineering, physics pathways); AI is more applied and data-focused (social sciences, business, design). We can assess and advise honestly.
