...
## A curriculum built for one child, not thirty.

The freedom of homeschooling, with the expertise of a dedicated math teacher.
...
We map out a coherent route through the year and beyond, aligned to Common Core or standards-independent, exactly as you prefer.
...
Notes after each class and progress summaries you can use for portfolios, evaluations, or simply your own confidence.

See how we'd plan it

## Building a path around one real child's gaps.
...
Number sense, counting, place value, and the first operations built on real understanding, gently and playfully.

### Upper elementary (3–5)

The four operations with fluency, fractions and decimals as real quantities, and confident word-problem reasoning.

### Middle school (6–8)

Ratios, percentages, the leap into pre-algebra and algebra, and the geometry and data that prepare for high school.

### High school (9–12)

Algebra 1 and 2, geometry, pre-calculus and beyond, with optional SAT/ACT and AP pathways as your teen approaches college.
...
Optional Common Core or state-standard mapping, plus progress notes for portfolios and evaluations.
...
- Force a child through a fixed pace they're not ready for.
- Teach rote procedures in place of understanding.
- Hide gaps to make progress look faster.
- Pretend to align with standards you didn't ask for.

How classes work

## Flexible enough for a homeschool day.

### 1:1, live

One child, one mentor, real-time video with a shared whiteboard. Real teaching, fully individual.

### 8 classes a month

Two each week, length suited to your child's age, woven into your homeschool rhythm.

### Daytime or evening

All six US zones, with daytime slots that fit homeschooling as well as evenings and weekends.

### Records included

Progress notes and summaries for your portfolio and your own peace of mind.
...
[See a course outline](/courses/comprehensive-middle-school-mathematics-mastery)

Browse a structured outline by stage: [**Elementary**](/courses/elementary-mathematics-complete-masterclass) · [**Middle School**](/courses/comprehensive-middle-school-mathematics-mastery) Mathematics.

Who teaches your child

## Mentors who respect how you've chosen to teach.
...
All six US time zones, with daytime, evening and weekend slots. Two weekly times.
...
[USA · ages 6–11Maths Tutoring for Kids](/online-maths-tutoring-for-kids-in-usa)[USA · grades 6–12Maths Tutoring for Teens](/online-maths-tutoring-for-teens-in-usa)[USA · competitionMath Olympiad & AMC](/math-olympiad-amc-tutoring)[USA · topicAlgebra Tutoring](/algebra-tutoring-online-usa)[USA · collegeMaths for College Students](/online-maths-tutoring-for-college-students-in-usa)[CourseElementary Mathematics Masterclass](/courses/elementary-mathematics-complete-masterclass)
