...
[Open Stage 1 →](/python-from-the-ground-up)Stage 2
...
[Open Stage 2 →](/numpy-pandas-matplotlib-masterclass)You are hereStage 3
...
start: high lossstep = learning rate × gradientminimum
...
These are the live, college-and-professional courses that carry the from-scratch approach into full specialisations. Look through them and pick the one that matches where you want to go. The complete catalogue lives in the [course atlas](/course-atlas).
...
[View course →](/courses/data-science-complete-masterclass-college)![Data Structures and Algorithms course thumbnail](/images/dsa-college.jpg)
...
You need their content, not necessarily the classes. [Stage 1, Python From the Ground Up](/python-from-the-ground-up), gives you the language. [Stage 2, the NumPy, Pandas and Matplotlib Masterclass](/numpy-pandas-matplotlib-masterclass), gives you data handling and the vector thinking that machine learning runs on. If you already have those skills you can start here. If you do not, take the earlier stages first, because we build models on top of NumPy arrays from day one.
