...
INDEXES="$HUB best-coding-class-in-london coding-and-ai-classes-in-scotland coding-and-ai-classes-in-wales coding-and-ai-classes-in-northern-ireland uk-coding-maths-and-ai-competitions-calendar"
for P in $INDEXES; do
  [ "$P" = "$SL" ] && continue
