...
const KIDS = {
    ...
    aiKids: { href: '/courses/kids-ai-mastery-course', pill: 'AI', img: IMG('ai-tools-kids.webp'), alt: 'AI tools for kids', title: 'AI Tools for Kids', desc: 'Teachable Machine + simple classifiers — hands-on AI.', tags: ['AI'] },
