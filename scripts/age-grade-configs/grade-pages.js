...
const KIDS = {
    ...
    aiKids: { href: '/courses/cbse-computational-thinking-and-ai-course-for-kids-classes-3-to-8', pill: 'AI', img: IMG('ct-ai-kids.webp'), alt: 'computational thinking and AI for kids', title: 'Computational Thinking & AI', desc: 'Teachable Machine, classifiers, simple chatbots — hands-on AI at the right depth.', tags: ['AI', 'No-code'] },
...
module.exports = [
    ...
    /* ---------- CLASS 5 ---------- */
    {
        ...
        skipBody: 'If your Class 5 child already has Scratch projects under the belt, <strong>skip repeating intro blocks</strong> and jump straight into <a href="/courses/python-ai-kids-masterclass" style="color:inherit;text-decoration:underline;">Python for Kids</a>, <a href="/courses/cbse-computational-thinking-and-ai-course-for-kids-classes-3-to-8" style="color:inherit;text-decoration:underline;">AI Tools</a> or <a href="/courses/kids-ai-web-development-course" style="color:inherit;text-decoration:underline;">Web Development</a>. Demo teacher confirms level in 10 minutes.',
    ...
    /* ---------- CLASS 6 ---------- */
    {
        ...
        skipBody: 'If your Class 6 child has Scratch or basic HTML under the belt, <strong>skip ahead</strong> into <a href="/courses/python-ai-kids-masterclass" style="color:inherit;text-decoration:underline;">Python with functions</a>, <a href="/courses/cbse-computational-thinking-and-ai-course-for-kids-classes-3-to-8" style="color:inherit;text-decoration:underline;">real AI Tools</a> or <a href="/courses/game-development-masterclass-for-kids" style="color:inherit;text-decoration:underline;">Game Dev</a>. Free demo places them.',
