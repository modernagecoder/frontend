...
const PY = {
    ...
    aiKids: { href: '/courses/kids-ai-mastery-course', pill: 'AI', img: IMG('ai-tools-kids.webp'), alt: 'AI tools for kids', title: 'AI Tools for Kids', desc: 'Teachable Machine, image classifiers — first hands-on taste of AI.', tags: ['AI', 'No-code'] },
