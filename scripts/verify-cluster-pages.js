...
const CLUSTERS = {
  ...
  'coding-global': {
    ...
    markets: ['om', 'mct', 'kw', 'bh', 'hk', 'nl', 'nj', 'ca', 'tx', 'ny', 'il',
      ...
      'bn', 'bsb', 'kb', 'tut', 'tem', 'ser', 'lia', 'gad', 'jer', 'amv', 'ams', 'ehv', 'dhg', 'alm', 'utr', 'rtm'],
