...
const CLUSTERS = {
  'build-ai': {
    ...
    markets: ['om', 'mct', 'kw', 'kwc', 'bh', 'ae', 'sa', 'qa', 'us', 'uk',
      ...
      'smc', 'bct', 'apk', 'aca', 'ooa', 'nla', 'agn', 'aam', 'aeh', 'adh', 'aut', 'art', 'ctn', 'ckn', 'cad', 'ccs', 'apn', 'brp', 'mln', 'ooc', 'pyn', 'gan', 'ags', 'jvn', 'ifn', 'fsn', 'dsn', 'adn', 'rmp', 'vbn', 'bcw', 'boi', 'ucp', 'lcg', 'acq', 'agi', 'jcc', 'bki', 'bti', 'tyc', 'asi', 'osc', 'ltt', 'pss', 'bai', 'cci', 'fsi', 'bpi', 'bra', 'dsi', 'lta', 'apr', 'jvi', 'adi', 'bou', 'ucc', 'bio', 'nea', 'ktm', 'pmc', 'beb'],
