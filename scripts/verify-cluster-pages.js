...
const CLUSTERS = {
  ...
  'coding-global': {
    ...
    markets: ['om', 'mct', 'kw', 'bh', 'hk', 'nl', 'nj', 'ca', 'tx', 'ny', 'il',
      ...
      'msd', 'wst', 'mus', 'jbb', 'rus', 'amr', 'sah', 'suw',
...
const OMAN_CITIES = new Set(['al-musanaah', 'jalan-bani-bu-ali', 'rustaq', 'al-amarat', 'saham', 'as-suwaiq', 'sohar', 'barka', 'salalah', 'nizwa', 'sur', 'ibra',
  'ibri', 'duqm', 'khasab']);
