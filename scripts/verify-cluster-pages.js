...
const CLUSTERS = {
  ...
  'board-prep': {
    ...
    prefix: 'bx',
    markets: ['cai', 'csy', 'cpy', 'cbe', 'cpf', 'ijv', 'isy', 'ipr', 'ibj', 'ibe', 'sim', 'sic'],
