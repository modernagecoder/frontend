...
const KID_COURSES = {
    ...
    aiKids: { href: '/courses/kids-ai-mastery-course', pill: 'AI', img: IMG('ai-tools-kids.webp'), alt: 'AI tools mastery for kids', title: 'AI Tools for Kids', desc: 'Teachable Machine, image classifiers, simple chatbots — a first hands-on taste of AI.', tags: ['AI', 'No-code ML'] },
...
const AGE_PAGES = [
    ...
    /* ---------- AGE 11 ---------- */
    {
        ...
        skipBody: 'If your child has already finished a Scratch course or a school computer unit, <strong>skip the basics</strong> and jump into a <a href="/courses/python-ai-kids-masterclass" style="color:inherit;text-decoration:underline;">Python</a>, <a href="/courses/kids-ai-mastery-course" style="color:inherit;text-decoration:underline;">AI Tools</a> or <a href="/courses/kids-ai-web-development-course" style="color:inherit;text-decoration:underline;">Web Development</a> track. We verify level in a free demo, no repeat content.',
