/**
 * Authority/SEO Category Blog Validation Script
 * Validates the 4 Authority/SEO category blog files against design requirements
 */

const fs = require('fs');
const path = require('path');

// Authority/SEO category blog files to validate
const blogFiles = [
  'coding-education-changing-future-india.json',
  'early-exposure-coding-competitive-advantage.json',
  'role-mathematics-programming-problem-solving.json',
  'schools-parents-prepare-children-tech-careers.json'
];
...
console.log('BLOG JSON VALIDATION - Authority/SEO Category');
console.log('='.repeat(70));
console.log('');
