...
| 109 | ai-and-python-academy-amsterdam (ag-aam, #994975) | ag- spoke (market) | 4,305 | 3.6% vs ai-and-python-academy-groningen | (ag- page: no AI H2; spine = the Algoritmeregister: Gemeente Amsterdam publishes 73 algorithms (of 1,553 in the national register); Parkeercontrole, Public Eye, Vroegsignalering and ChatAmsterdam read closely; every student project ends with an entry of the same shape) | none (ag- pages carry a spine, not a data trap) | (this commit) |
