...
| 96 | coding-classes-in-veenendaal (vnd, #750B00) | city | 4,099 | 2.6% vs vlaardingen | An AI reads every word in pieces. Why should a teenager in Veenendaal learn where it cuts? | tokenization: Veenen-Daal not Veen-en-Daal; one rule, three vocabularies, three cuts; tokens and cost | (this commit) |
...
(where a word is cut decides what it says).
