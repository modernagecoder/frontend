...
| 125 | java-classes-netherlands (ag-jvn, #88375F) | ag- language door (market) | 3,114 | 4.8% vs python-classes-netherlands | (ag- page: no AI H2; spine = Java is the language of AP Computer Science A (College Board: a subset of Java, one-semester college equivalent, exam 12 May 2027); the American School of The Hague in Wassenaar offers both IB and AP; when Java is the right first language and when Python is) | none (ag- pages carry a spine, not a data trap) | (this commit) |
