...
| 87 | coding-classes-in-meierijstad (mrs, #377338) | city | 4,243 | 5.9% vs heerlen | An AI classifier always names a winner. Why should a teenager in Veghel ask how big the win was? | plurality is not majority: report share and margin with the winner; argmax and forest votes | (this commit) |
...
versus majority (argmax, forest votes) by Meierijstad.
