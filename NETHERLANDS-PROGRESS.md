...
| 110 | ai-and-python-academy-eindhoven (ag-aeh, #076B29) | ag- spoke (market) | 4,076 | 4.7% vs ai-and-python-academy-amsterdam | (ag- page: no AI H2; spine = AI that has to move: EAISI (300 staff, 600 PhD candidates), the AI and Engineering Systems master and TU/e student teams; Tech United TURTLEs (8 Middle Size League titles) and three problems from their 2025 team description: manufactured data, drift and self-calibration, the sim-to-real gap (goalkeeper at 23 percent)) | none (ag- pages carry a spine, not a data trap) | (this commit) |
