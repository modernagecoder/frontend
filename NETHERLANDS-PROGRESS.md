...
| 103 | coding-classes-in-oegstgeest (ogg, #0C665A) | city | 3,979 | 4.0% vs bergen-op-zoom | An AI can take on a huge task in one go. Why should a teenager in Oegstgeest learn to split it first? | divide and conquer: Descartes at Endegeest; halving finds 1 in 1,000 in 10 questions; split before asking AI | (this commit) |
...
(halving, binary search, decomposition for AI).
