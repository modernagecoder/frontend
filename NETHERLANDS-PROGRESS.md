...
| 76 | coding-classes-in-woensel-zuid (wsz, #615927) | district | 5,296 | 2.8% vs stratum | An AI reading the encyclopaedia will say Woensel-Zuid has 64,790 residents. Why should a teenager in Limbeek check the area first? | A check invariant under an error cannot detect it (Woensel boxes swapped: each self-consistent, both sum to Woensel; only the office areas of the listed wijken, 824 ha vs 1,864, catch it; elfproef) | (this commit) |
