...
| 129 | app-development-course-netherlands (ag-adn, #35366B) | ag- track door (market) | 3,060 | 3.3% vs java-classes-netherlands | (ag- page: no AI H2; spine = the app millions rely on is an identity app: Logius reports DigiD used 645 million times in 2025 and almost 370 million successful logins in the first half of 2026, almost three quarters with the DigiD app and more than half with the app plus ID-check; apps that matter are about trust, security and reliability) | none (ag- pages carry a spine, not a data trap) | (this commit) |
