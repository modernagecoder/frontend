...
| 104 | coding-classes-in-rijswijk (rjw, #6B1E1F) | city | 4,154 | 4.2% vs velsen | An AI model can change its answers after an update. Why should a teenager in Rijswijk learn to write contracts? | API contracts: the Peace of 1697 as image; semantic versioning, deprecation, contract tests, pinned AI models | (this commit) |
...
versioning (semver, deprecation, pinned AI model versions).
