...
| 99 | coding-classes-in-velsen (vls, #A83B6C) | city | 4,016 | 4.9% vs assen | An AI can rewrite code to be faster in seconds. Why should a teenager in IJmuiden measure first? | bottlenecks: the IJmuiden locks; a step saves at most its own time; measure, widen the narrowest, re-measure | (this commit) |
...
first, widen the narrowest step, re-measure).
