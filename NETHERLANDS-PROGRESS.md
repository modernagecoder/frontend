...
| 91 | coding-classes-in-roosendaal (rsd, #A24B3B) | city | 4,279 | 1.7% vs meierijstad | An AI agent will read any web page you give it. Why should a teenager in Roosendaal ask who wrote that page? | trust boundaries: check everything that crosses into a program, once, at the border; prompt injection | (this commit) |
...
once at the border; prompt injection).
