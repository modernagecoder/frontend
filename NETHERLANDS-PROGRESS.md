...
| 83 | coding-classes-in-sittard-geleen (stg, #483D06) | city | 4,486 | 4.3% vs hilversum | An image model pads the edge of every picture it sees. Why should a teenager in Sittard learn what happens at a border? | edge effect: neighbourhood calculations are cut off where the data stops, not where the world does | (this commit) |
